...
export default function InquiryForm({ selectedBoat }: InquiryFormProps) {
    ...
    const inputClasses = "w-full bg-white/40 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl p-4 outline-none focus:ring-2 focus:ring-brand-green/30 focus:border-brand-green transition-all duration-300 placeholder:text-gray-500 dark:placeholder:text-gray-400 backdrop-blur-sm";
        ...
        <div className="bg-white/40 dark:bg-[#121212]/60 backdrop-blur-xl rounded-[2.5rem] overflow-hidden border border-white dark:border-white/5 shadow-[0_20px_50px_rgba(0,0,0,0.05)] transition-all duration-500">
            <div className="p-8 md:p-14">
                ...
                <div className="mb-14 relative">
                    <div className="absolute -top-6 -left-6 w-20 h-20 bg-brand-green/10 rounded-full blur-2xl animate-pulse"></div>
                    <div className="relative">
                        <h2 className="text-4xl md:text-6xl font-serif font-bold text-(--color-secondary) dark:text-white mb-6 leading-tight">
                            Start Your <br />
                            <span className="text-transparent bg-clip-text bg-linear-to-r from-brand-green to-[#8bbd2e]">Ecuadorian Adventure</span>
                        </h2>
                        <div className="h-1 w-24 bg-linear-to-r from-brand-green to-transparent rounded-full mb-6"></div>
                ...
                <form onSubmit={handleSubmit} className="space-y-14">
                    ...
                    <div className="space-y-10">
                        <div className="flex items-center gap-4">
                            <span className="flex-none w-10 h-10 rounded-full bg-brand-green/10 text-brand-green flex items-center justify-center font-bold font-serif text-xl border border-brand-green/20 shadow-inner">1</span>
                            <h3 className="text-2xl font-serif font-bold text-(--color-secondary) dark:text-white">Trip Essentials</h3>
                        </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative group">
                                        ...
                                        <div className="absolute inset-y-0 right-3 flex flex-col justify-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                            <div className="w-4 h-4 text-gray-400 hover:text-brand-green cursor-pointer">▲</div>
                                            <div className="w-4 h-4 text-gray-400 hover:text-brand-green cursor-pointer">▼</div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div
                                        ...
                                        className={`relative p-5 rounded-2xl border-2 transition-all duration-300 cursor-pointer flex flex-col items-center justify-center gap-3 text-center
                                            ${formData.interests[item.id as keyof typeof formData.interests]
                                                ? 'bg-brand-green border-brand-green text-white shadow-[0_10px_20px_rgba(92,124,30,0.2)]'
                                                : 'bg-white/50 dark:bg-white/5 border-gray-100 dark:border-white/5 text-gray-600 dark:text-gray-400 hover:border-brand-green/30'
                                            }`}
                                    >
                                        <div className={formData.interests[item.id as keyof typeof formData.interests] ? 'text-white' : 'text-brand-green'}>
                                            {item.icon}
                                        </div>
                    ...
                    <div className="space-y-8">
                        <div className="flex items-center gap-4">
                            <span className="flex-none w-10 h-10 rounded-full bg-brand-green/10 text-brand-green flex items-center justify-center font-bold font-serif text-xl border border-brand-green/20 shadow-inner">2</span>
                            <h3 className="text-2xl font-serif font-bold text-(--color-secondary) dark:text-white">Your Vision</h3>
                        </div>
                        <div className="relative">
                    ...
                    <div className="space-y-10">
                        <div className="flex items-center gap-4">
                            <span className="flex-none w-10 h-10 rounded-full bg-brand-green/10 text-brand-green flex items-center justify-center font-bold font-serif text-xl border border-brand-green/20 shadow-inner">3</span>
                            <h3 className="text-2xl font-serif font-bold text-(--color-secondary) dark:text-white">How to Reach You</h3>
                        </div>
                    ...
                    <div className="pt-10 border-t border-gray-100 dark:border-white/5 flex flex-col items-center">
                        <label htmlFor="newsletter" className="flex items-center group cursor-pointer mb-10 w-full max-w-lg">
                            <div className="relative flex items-center justify-center flex-none">
                                <input
                                    ...
                                    onChange={handleChange}
                                    className="peer appearance-none w-6 h-6 border-2 border-gray-200 dark:border-white/10 rounded-full checked:bg-brand-green checked:border-brand-green transition-all duration-300"
                                />
                        ...
                        <button
                            type="submit"
                            className="group relative inline-flex items-center justify-center px-12 py-6 font-black text-white dark:text-black transition-all duration-500 bg-brand-green rounded-4xl hover:bg-brand-green-dark shadow-[0_15px_30px_rgba(92,124,30,0.3)] hover:-translate-y-2 active:scale-95 overflow-hidden w-full md:w-auto"
                        >
                        ...
                        <div className="mt-10 flex items-center gap-6 text-xs text-gray-600 dark:text-gray-300 font-bold uppercase tracking-widest bg-gray-50 dark:bg-white/5 px-8 py-3 rounded-full">
                            <span className="flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4 text-brand-green">
