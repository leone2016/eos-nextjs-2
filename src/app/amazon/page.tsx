            ...
            <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center text-white px-4 max-w-4xl">
                    ...
                    <h1 className="text-6xl md:text-8xl lg:text-9xl font-serif font-bold mb-8 drop-shadow-2xl tracking-tight leading-[0.9]">
                        Amazon <br />
                        <span className="italic text-brand-green">Untamed</span>
                    </h1>
                </div>
            ...
            <section className="relative py-24 -mt-12 z-20">
                <div className="container mx-auto px-4 max-w-4xl text-center">
                    <h2 className="text-4xl md:text-5xl font-serif font-bold text-(--color-secondary) dark:text-white mb-8 leading-tight">
                        Immerse yourself in the world&apos;s <span className="text-brand-green">most biodiverse</span> ecosystem.
                    </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
                        ...
                        <Link href="/amazon/deep-jungle-lodge" className="group block relative rounded-[2.5rem] overflow-hidden bg-white dark:bg-[#1a1a1a] shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-white dark:border-white/5 shadow-[0_10px_40px_rgba(0,0,0,0.04)] dark:shadow-none">
                            ...
                            <div className="p-10">
                                ...
                                <span className="text-brand-green font-bold uppercase tracking-[0.2em] text-xs cursor-pointer group-hover:text-brand-green-dark transition-colors">Explore Options →</span>
                            </div>
                        </Link>
