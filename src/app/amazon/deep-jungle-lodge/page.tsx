    ...
    return (
        <div className="min-h-screen pb-20 bg-background relative">
            ...
            <section className="container mx-auto px-4 pt-16 pb-8 text-center max-w-4xl">
                <h2 className="text-3xl font-serif font-bold text-(--color-secondary) dark:text-white mb-6">Experience the Pristine Amazon Jungle</h2>
            ...
            <section className="container mx-auto px-4 py-8">
                    ...
                    {amazonLodges.map((lodge) => (
                        <div key={lodge.id} className="bg-white dark:bg-[#1a1a1a] rounded-xl shadow-lg dark:shadow-[0_4px_20px_0_rgba(255,255,255,0.08)] overflow-hidden hover:shadow-2xl transition-all duration-300 flex flex-col border border-transparent dark:border-white/5">
                            ...
                            <div className="p-6 flex flex-col grow">
                                <h3 className="text-2xl font-serif font-bold text-(--color-secondary) mb-2">{lodge.name}</h3>
                                <p className="text-gray-600 dark:text-gray-400 text-sm mb-6 grow">{lodge.description}</p>
                                <div className="border-t border-gray-100 dark:border-gray-800 pt-4 flex items-center justify-center">
                                    <Link
                                        ...
                                        className="px-6 py-2 bg-brand-green text-white text-sm font-bold rounded-full hover:bg-brand-green-dark transition-colors w-full text-center"
                                    >
                ...
                <div className="flex justify-center mt-16">
                    <Link href="/amazon" className="text-brand-green hover:underline flex items-center gap-2">
