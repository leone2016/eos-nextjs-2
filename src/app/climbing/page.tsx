            ...
            <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center text-white px-4 max-w-4xl">
                    ...
                    <h1 className="text-6xl md:text-8xl lg:text-9xl font-serif font-bold mb-8 drop-shadow-2xl tracking-tight leading-[0.9]">
                        Climbing <br />
                        <span className="italic text-brand-green">& Trekking</span>
                    </h1>
                </div>
            ...
            <section className="relative py-24 -mt-12 z-20">
                <div className="container mx-auto px-4 max-w-4xl text-center">
                    <h2 className="text-4xl md:text-5xl font-serif font-bold text-(--color-secondary) dark:text-white mb-8 leading-tight">
                        Reach new heights in the <span className="text-brand-green">heart of the Andes</span>.
                    </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
                        ...
                        <div className="group block relative rounded-[2.5rem] overflow-hidden bg-white dark:bg-[#1a1a1a] shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-white dark:border-white/5 shadow-[0_10px_40px_rgba(0,0,0,0.04)] dark:shadow-none">
                            ...
                            <div className="p-10">
                                ...
                                <span className="text-brand-green font-bold uppercase tracking-[0.2em] text-xs cursor-pointer">View Expeditions →</span>
                            </div>
                        </div>
                        ...
                        <div className="group block relative rounded-[2.5rem] overflow-hidden bg-white dark:bg-[#1a1a1a] shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-white dark:border-white/5 shadow-[0_10px_40px_rgba(0,0,0,0.04)] dark:shadow-none">
                            ...
                            <div className="p-10">
                                ...
                                <span className="text-brand-green font-bold uppercase tracking-[0.2em] text-xs cursor-pointer">View Treks →</span>
                            </div>
                        </div>
