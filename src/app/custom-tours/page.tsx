            ...
            <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center text-white px-4 max-w-4xl">
                    ...
                    <h1 className="text-6xl md:text-8xl lg:text-9xl font-serif font-bold mb-8 drop-shadow-2xl tracking-tight leading-[0.9]">
                        Design Your <br />
                        <span className="italic text-brand-green">Dream Trip</span>
                    </h1>
                </div>
            ...
            <section className="relative py-24 -mt-12 z-20">
                <div className="container mx-auto px-4 max-w-4xl text-center">
                    <h2 className="text-4xl md:text-5xl font-serif font-bold text-(--color-secondary) dark:text-white mb-8 leading-tight">
                        Designed <span className="text-brand-green">around you</span>.
                    </h2>
            ...
            <section className="py-20 pb-40">
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto rounded-[3rem] overflow-hidden bg-white dark:bg-[#1a1a1a] shadow-2xl border border-white dark:border-white/5 p-10 md:p-20 text-center">
                        <div className="mb-12">
                            <h3 className="text-4xl md:text-5xl font-serif font-bold text-(--color-secondary) dark:text-white mb-6">Start Planning Today</h3>
                        ...
                        <div className="flex justify-center">
                            <Link
                                href="/contact"
                                className="group relative inline-flex items-center justify-center px-12 py-5 font-bold text-white transition-all duration-300 bg-brand-green rounded-full hover:bg-brand-green-dark hover:shadow-2xl hover:shadow-(--color-primary)/20 active:scale-95 overflow-hidden"
                            >
